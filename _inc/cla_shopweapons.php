<?php
// cla_shopweapons.php
$sql = mysqli_query($mysqli_link, "SELECT * FROM table_itens WHERE clashop='sim' AND categoria='arma' ORDER BY valor ASC");
...
?>
    <div style="background: rgba(0,0,0,0.2); border: 1px solid #333; padding: 15px; border-radius: 8px; display: flex; flex-direction: column; justify-content: space-between;">
        <div style="display: flex; gap: 15px; margin-bottom: 10px;">
            <img src="_img/itens/<?php echo $row['id']; ?>.png" onerror="this.src='_img/itens/default_arma.png'" style="width: 60px; height: 60px; border: 1px solid #444; border-radius: 4px; background: #111;">
            <div style="flex: 1;">
        ...
        <div style="display: flex; justify-content: space-between; align-items: center;">
            ...
            <form method="post" action="?p=cla_shop">
                ...
                <input type="hidden" name="buy_cat2" value="arma">

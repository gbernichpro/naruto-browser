<?php
if(date('Y-m-d H:i:s')>='2010-02-10 00:00:00'){ echo "<script>self.location='?p=home&e=1'</script>"; return; }
if(!isset($_GET['akatsuki'])){ echo "<script>self.location='?p=home&e=1'</script>"; return; }
if($db['vila']==8){ echo "<script>self.location='?p=home&e=3'</script>"; return; }

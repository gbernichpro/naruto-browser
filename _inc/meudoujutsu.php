...
switch($db['doujutsu']){
	...
	case 4: $txtdoujutsu='Mangekyou_Sharingan'; $habilidades='- Bônus de '.($db['doujutsu_nivel']*4).'% no Genjutsu;<br />- 5 Jutsus.'; break;
}
?>
...
<?php if($db['doujutsu']==4){ ?>document.getElementById('atrgen').innerHTML=((document.getElementById('atrgen').innerHTML)*1)+<?php echo round($db['genjutsu']*($db['doujutsu_nivel']/50)); ?>;<?php } ?>
</script>

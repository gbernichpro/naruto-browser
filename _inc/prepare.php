...
<div class="box_middle">Atributos de combate, nível e experiência de <?php echo ucfirst($db['usuario']); ?>.<div class="sep"></div>
    ...
    <div class="sep"></div>
    <div align="center">
    	<input type="button" class="botao<?php if($_SESSION['bot']<>1) echo '_dis'; else echo '_en'; ?>" value="Atacar" onclick="location.href='?p=attack&bot=1'" />
        <input type="button" class="botao<?php if($_SESSION['bot']<>2) echo '_dis'; else echo '_en'; ?>" value="Atacar" onclick="location.href='?p=attack&bot=2'" />
        <input type="button" class="botao<?php if($_SESSION['bot']<>3) echo '_dis'; else echo '_en'; ?>" value="Atacar" onclick="location.href='?p=attack&bot=3'" />
        <input type="button" class="botao<?php if($_SESSION['bot']<>4) echo '_dis'; else echo '_en'; ?>" value="Atacar" onclick="location.href='?p=attack&bot=4'" />
        <input type="button" class="botao<?php if($_SESSION['bot']<>5) echo '_dis'; else echo '_en'; ?>" value="Atacar" onclick="location.href='?p=attack&bot=5'" />
    </div>
    <?php } ?>
</div>

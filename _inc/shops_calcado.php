...
$sqls=mysql_query("SELECT id,nome,categoria FROM table_itens Where categoria='calcado' ORDER BY nome ASC");
...
<b>Selecione o Item:</b><br />
    ...
    <span class="sub2">Selecione o item que deseja pesquisar.<?php echo $categoria;?></span>

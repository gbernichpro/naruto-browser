...
if(isset($_POST['train'])){
	...
	vn($train); vn($tempo);
	if(($tempo<10)or($tempo>480)){ echo "<script>self.location='?p=home'</script>"; return; }
...
&raquo; Treinar Seus Jutsus!</b></div><br>
<div style="margin-left: 0px;margin-top: 35px;font-family: arial;font-size: 12px;color: #fff;"><b>

Aperfeiçoe tudo que você aprendeu até o momento! Escolha o que deseja treinar, e por</br>
quanto tempo. Lembre-se que a cada 10 minutos treinados, você adquire 2 pontos de</br>
experiência para a habilidade escolhida. Seu treinamento não será feito na sala, e</br>
 sim no pátio da escola, portanto esta sala ficará disponível para outros ninjas.</br>
</br>
</b>

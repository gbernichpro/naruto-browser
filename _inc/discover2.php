...
$nat=rand(1,5);
switch($nat){
	case 1: $txtnat='fogo'; $desc='Fogo (Katon)'; return;
...
if($txtnat==$db['natureza1']){ echo "<script>self.location='?p=room&id=".$_GET['id']."&msg=10'</script>"; return; }
if($db['natureza2']=='') mysql_query("UPDATE usuarios SET natureza2='$txtnat' WHERE id=".$db['id']);
?>

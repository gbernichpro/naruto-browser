<?php
$categoria='animais';
$sqls=mysql_query("SELECT * FROM table_animais WHERE categoria='animais'  AND credshop='sim' ");
$dbs=mysql_fetch_assoc($sqls);

?>
<table width="100%" cellpadding="0" cellspacing="1">
    <?php if(mysql_num_rows($sqls)==0) echo '<tr><td colspan="3"><div class="aviso">Nenhum animal.</div></td></tr>';  else do{ if(date('Y-m-d H:i:s')<$db['vip']) $dbs['valor']=$dbs['valor']-($dbs['valor']);?>

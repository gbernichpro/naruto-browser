<?php
if(isset($_POST['id'])){
    $juniorgato=mysql_query("Select pass from usuarios where id=".antiinjection($db['id']));
	...
	$sqlv=mysql_query("SELECT valor FROM table_animais WHERE id=".antiinjection($dbi['itemid']));
...
?>
<div class="box_top">Venda de Pets</div>
<div class="box_middle">Aki é onde você venderá seu animal para o sistema ou seja você pode vender seu item para o jogo recebendo na hora mas lembre que será a metade do preço pago no comercio.<div class="sep"></div>
    ...
    <tr class="table_dados" style="background:#323232;" onmouseover="style.background='#2C2C2C'" onmouseout="style.background='#323232'">
        ...
        <td style="padding:5px;">
            ...
            <form method="post" action="?p=mypet" onsubmit="var b=this.querySelector('input[type=submit]'); if(b) { b.value='Carregando...'; b.disabled=true; }">

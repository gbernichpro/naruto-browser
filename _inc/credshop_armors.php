...
$sqls = mysql_query("SELECT * FROM table_itens WHERE categoria='vestimenta' AND credshop='sim' ");
...
<table width="100%" cellpadding="0" cellspacing="1">
    ...
    <?php if(mysql_num_rows($sqls)==0) echo '<tr><td colspan="3"><div class="aviso">Nenhum item encontrado.</div></td></tr>'; else do{ if(date('Y-m-d H:i:s')<$db['vip']) $dbs['valor']=$dbs['valor']-($dbs['valor']); ?>
    <tr style="background:#161616;" onmouseover="style.background='#310000'" onmouseout="style.background='#161616'">
        ...
        <td align="center" width="20%">
            ...
            <form method="post" action="?p=credshop" onsubmit="var b=this.querySelector('input[type=submit]'); if(b) { b.value='Carregando...'; b.disabled=true; }">

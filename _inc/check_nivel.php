...
if($_SESSION['exp']>=$_SESSION['expmax']){
	...
	mysql_query("UPDATE usuarios SET nivel=nivel+1, exp=$difexp, expmax=$novaexpmax, yens=yens+100, yens_fat=yens_fat+100, energia=energia+100, energiamax=energiamax+100 WHERE id='".antiinjection($_SESSION['id'])."'");
	$mudanca=1;
}
?>
<?php if($mudanca==1){ ?>

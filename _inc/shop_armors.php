...
$sqls = mysql_query("SELECT * FROM table_itens WHERE categoria='vestimenta' AND reqnivel<$dif ".$addsql."ORDER BY reqnivel ASC");
...
<table width="100%" cellpadding="0" cellspacing="1">
    ...
    <tr style="background:#161616;" onmouseover="style.background='#310000'" onmouseout="style.background='#161616'">
    	<td align="center" width="140"><img src="_img/equipamentos/<?php echo $dbs['imagem']; ?>.png" width="162" /></td>

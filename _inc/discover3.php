...
if($txtnat==$db['natureza2']){ echo "<script>self.location='?p=room&id=".$_GET['id']."&msg=11'</script>"; return; }
if($db['natureza3']=='') mysql_query("UPDATE usuarios SET natureza3='$txtnat' WHERE id=".$db['id']);
?>

...
&raquo; Seja bem vindo!</b></div><br>
<div style="margin-left: 0px;margin-top: 35px;font-family: arial;font-size: 12px;color: #fff;"><b>
Seja bem-vindo ao Naruto <?php echo NARUTO_NOME; ?>! Como este é seu primeiro login no jogo,</br>
queremos que você escolha um avatar para representação. Marque uma das 12</br>
opções abaixo, e clique no botão para confirmar. Lembramos que esta função</br>
não interfere na força da sua conta. A troca de avatares pode ser feita uma</br>
vez por dia (ilimitado para jogadores VIP).
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td align="center"><input type="radio" id="fir_avatar11" name="fir_avatar" value="<?php echo $c->encode('11',$chaveuniversal); ?>" /></td>
        <td align="center"><input type="radio" id="fir_avatar12" name="fir_avatar" value="<?php echo $c->encode('12',$chaveuniversal); ?>" /></td>
      </tr>
    </table>
    <div class="sep"></div>

...
if(($db['missao']==999)&&($atual<$db['missao_fim'])){ echo "<script>self.location='?p=logout'</script>"; return; }
if($db['missao']>0){
...
<img width="142" style="" src="_img/_detalhes/msg/55.png"></td><td valign="top"><br><br><br>

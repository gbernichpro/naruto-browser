...
<fieldset><legend>Alterar Personagem</legend>
	...
	<table width="100%" cellpadding="0" cellspacing="1">
        ...
        <?php if($dbp[mysql_field_name($sqlp,$i)]==1){ $x=1; $campo=mysql_field_name($sqlp,$i); ?>
        	<td><img src="_img/personagens/<?php echo $campo; ?>/0.jpg" width="110" height="60" onmouseover="Tip('<div class=tooltip><?php fpersonagem($campo); ?></div>')" onmouseout="UnTip()" /><br /><input type="radio" id="char_personagem<?php echo $i+3; ?>" name="char_personagem" value="<?php echo $campo; ?>" <?php if($db['personagem']==mysql_field_name($sqlp,$i)) echo 'checked="checked"'; ?> /></td>

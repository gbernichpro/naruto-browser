...
if($db['nivel']<40){ echo "<script>self.location='?p=room&id=".$_GET['id']."&msg=7'</script>"; return; }
if($db['natureza2']<>''){ echo "<script>self.location='?p=room&id=".$_GET['id']."&msg=6'</script>"; return; }
...
<div class="box_top">2° Natureza do Chakra</div>
<div class="box_middle">Acredito que você está pronto para dominar a 2° natureza do seu chakra. Como vamos descobrir a 2° natureza de seu chakra, utilizaremos um método muito simples, que é através de papéis sensíveis ao chakra. Basta você concentrar sua energia que o papel irá reagir, e então saberemos os tipos de jutsus que você poderá usar!<div class="sep"></div>
    ...
    <div align="center"><img src="_img/jutsus/papel_chakra.jpg" /><div class="sep"></div><span class="sub2">Este método é muito eficiente, e lhe ajudará a descobrir a 2° natureza de seu chakra.<br />Assim que estiver pronto...<div class="sep"></div><input type="button" class="botao" onclick="location.href='?p=discover2&id=<?php echo $_GET['id']; ?>'" value="Concentrar Chakra" /></span></div>
</div>

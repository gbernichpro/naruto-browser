...
<table width="100%" cellpadding="0" cellspacing="1">
  ...
  <tr style="background:#161616;" onmouseover="style.background='#310000'" onmouseout="style.background='#161616'">
    ...
    <td style="padding-left:5px;"><?php if($dbmm['origem']==0) echo '<b>Equipe '.NARUTO_NOME.'</b>'; else { ?><a href="?p=view&amp;view=<?php echo strtolower($dbmm['usuario']); ?>"><?php echo $dbmm['usuario']; ?></a><?php } ?><br /><span class="sub2"><b>Assunto:</b> <?php echo $dbmm['assunto']; ?></span></td>
